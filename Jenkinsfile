pipeline {
  ...
  environment {
    ...
    TESTING_PIPELINE_EXECUTION_ROLE = 'arn:aws:iam::161342106387:role/aws-sam-cli-managed-dev-pipe-PipelineExecutionRole-9VC72KEOOQWC'
    TESTING_CLOUDFORMATION_EXECUTION_ROLE = 'arn:aws:iam::161342106387:role/aws-sam-cli-managed-dev-p-CloudFormationExecutionR-1QKMDBCKMO4K6'
    TESTING_ARTIFACTS_BUCKET = 'aws-sam-cli-managed-dev-pipeline-artifactsbucket-bffv5nkmwi0q'
    // If there are functions with "Image" PackageType in your template,
    // uncomment the line below and add "--image-repository ${TESTING_IMAGE_REPOSITORY}" to
    // testing "sam package" and "sam deploy" commands.
    // TESTING_IMAGE_REPOSITORY = '0123456789.dkr.ecr.region.amazonaws.com/repository-name'
    TESTING_REGION = 'ap-southeast-1'
    PROD_STACK_NAME = 'purchase-order-dev-2'
    PROD_PIPELINE_EXECUTION_ROLE = 'arn:aws:iam::161342106387:role/aws-sam-cli-managed-dev-pipe-PipelineExecutionRole-9VC72KEOOQWC'
    PROD_CLOUDFORMATION_EXECUTION_ROLE = 'arn:aws:iam::161342106387:role/aws-sam-cli-managed-dev-p-CloudFormationExecutionR-1QKMDBCKMO4K6'
    PROD_ARTIFACTS_BUCKET = 'aws-sam-cli-managed-dev-pipeline-artifactsbucket-bffv5nkmwi0q'
    // If there are functions with "Image" PackageType in your template,
